                    ...
                    <ul>
                        ...
                        {{-- <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li><a href="{{ route('expenses.index') }}">Dépenses</a></li>
                                <li><a href="{{ route('salary.index') }}">Salaire</a></li>
                                <li><a href="{{ route('fees-collections.create') }}">Ajouter des frais</a></li>
                                <li><a href="{{ route('expenses.create') }}">Ajouter des dépenses</a></li>
                                <li><a href="{{ route('salary.create') }}">Ajouter un salaire</a></li>
                            </ul>
